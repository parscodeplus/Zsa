/**
 * v0 by Vercel.
 * @see https://v0.dev/t/xfTWaX5cCJV
  ...
  const features = [
    {
      ...
      description: "Stay organized and on top of your to-dos.",
    },
    {
      category: "productivity",
      icon: "Calendar",
      title: "Scheduling",
      description: "Easily manage your calendar and appointments.",
    },
    {
    ...
    },
    {
      ...
      description: "Gain insights to improve your workflow.",
    },
    {
      category: "productivity",
      icon: "Notepad",
      title: "Note-taking",
      description: "Capture your ideas and thoughts effortlessly.",
    },
    {
      category: "collaboration",
      icon: "Share",
      title: "File Sharing",
      description: "Securely share files and documents with your team.",
    },
    {
      category: "analytics",
      icon: "Pie",
    ...
    },
    {
      ...
      icon: "Clock",
      title: "Time Tracking",
      description: "Monitor your team's productivity and billable hours.",
    },
  ]
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Discover the features that can transform your workflow and boost your productivity.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <Button
              variant={activeCategory === "collaboration" ? "default" : "outline"}
...
function NotepadTextIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
