...
function BottomNavigation() {
  ...
  return (
    <div className='fixed bottom-0 left-0 z-50 flex h-16 w-full items-center justify-center bg-transparent'>
      <div className='z-0 flex w-full items-center justify-center space-x-2 rounded-t-2xl bg-primary p-4 dark:bg-background'>
        {tabs.map((tab) => (
          <div
            key={tab.id}
          ...
          >
            ...
            <div className='flex flex-col items-center justify-center'>
              <button
                className={`transition-top relative flex h-10 w-10 items-center justify-center rounded-full bg-blue-600 text-white shadow-[0px_2px_0px_0px_#FFFFFF40_inset] duration-300 hover:bg-blue-700 ${
                  activeTab === tab.id
                    ? '-top-1 animate-bounce duration-1000'
              ...
              >
                <tab.icon
                  className={`transition-top relative h-6 w-6 duration-300 ${
                    activeTab === tab.id
                      ? '-top-1 animate-bounce text-white duration-1000'
